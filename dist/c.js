...
var e = [/^enum(?![a-zA-Z¡-￿_0-9])/, /^for(?![a-zA-Z¡-￿_0-9])/, /^while(?![a-zA-Z¡-￿_0-9])/, /^do(?![a-zA-Z¡-￿_0-9])/, /^if(?![a-zA-Z¡-￿_0-9])/, /^switch(?![a-zA-Z¡-￿_0-9])/, /^(?:break|continue)(?![a-zA-Z¡-￿_0-9])/, /^goto(?![a-zA-Z¡-￿_0-9])/, /^return(?![a-zA-Z¡-￿_0-9])/, /^(?:struct|union)(?![a-zA-Z¡-￿_0-9])/, /^default(?![a-zA-Z¡-￿_0-9])/, /^case(?![a-zA-Z¡-￿_0-9])/, /^else(?![a-zA-Z¡-￿_0-9])/, /^[a-zA-Z¡-￿_][a-zA-Z¡-￿_0-9]*/, /^auto(?![a-zA-Z¡-￿_0-9])/, /^(?:register|static|extern|typedef)(?![a-zA-Z¡-￿_0-9])/, /^(?:const|volatile)(?![a-zA-Z¡-￿_0-9])/, /^(?:unsigned|signed|long)(?![a-zA-Z¡-￿_0-9])/, /^(?:int|float|double|char|short)(?![a-zA-Z¡-￿_0-9])/, /^(?:\+\+|\-\-|\!|\~|\&|\*|\+)/, /^sizeof(?![a-zA-Z¡-￿_0-9])/, /^(?:true|false|null)(?![a-zA-Z¡-￿_0-9])/, /^(?:0x[0-9a-fA-F]+|(?:[0-9]+(?:\.[0-9]*)?|\.[0-9]+)(?:[eE]\-?[0-9]+)?)[LlUuFf]?/, /^(?:\+\+|\-\-)/, /^(?:\!|\+|\-|\/|\*|\%|\>\>?|\<\<?|\=|\|\|?|\&\&?)\=?/, [0, /^[a-zA-Z¡-￿_]/, /^[a-zA-Z¡-￿_0-9]*/, [5, 221]], [1, "\n", "\t", " "], /^\@(?:member|param|arg(?:ument)?|module|namespace|typedef)(?![a-zA-Z¡-￿_])/, /^\@[a-zA-Z¡-￿_]+/, /^[a-zA-Z¡-￿_]+/, [0, /^(?!\*\/|\@[a-zA-Z¡-￿_]|\{)/, /^[^]/], /^[a-zA-Z¡-￿_][a-zA-Z¡-￿_0-9]*(?= *\()/];
var nodes = [
  ...
  [/^\/\*\*(?!\/)/, 100,
   ...
   /^\/\/.*/, -1],
  [0, 101,
   2, 205, 100, {"name":"doccomment.braced"},
   0, 102],
  [e[30], 103],
  [2, 213, 102, {"name":"doccomment.tagGroup"},
   "*/", -1],
  [0, 101,
   0, 100],
  [[0, /^(?!\*\/)/, /^[^]/], 104,
  ...
  [3, "operator", e[19], 127,
   3, "keyword", e[20], 127,
   2, 230, 128, {"name":"ParenExpr"},
   3, "atom", e[21], 130,
   3, "number", e[22], 130,
   2, 95, 130, {"name":"string","token":"string"},
   2, 235, 130, {"name":"BlockOf"},
  ...
  [1, 9, 140],
  [1, 126, 141],
  [2, 255, 132, {"name":"fieldName","token":"property"}],
  [1, 126, 132],
  [1, 126, 142],
  [1, 9, 143],
  [1, 9, 144],
  ...
  [1, 256, 173,
   0, 190],
  [1, 9, 174],
  [2, 255, 175, {"name":"fieldName","token":"property"},
   0, 175],
  [1, 9, 176],
  [":", 177,
   0, 178],
  ...
  [1, 256, 183],
  [1, 9, 184],
  [2, 255, 185, {"name":"fieldName","token":"property"},
   0, 185],
  [1, 9, 186],
  [":", 187,
   0, 188],
  ...
  [3, "tag", e[27], 207,
   3, "tag", e[28], 208,
   2, 271, 212, {"name":"doccomment.type","token":"type"}],
  [e[26], 207,
   "{", 209,
   0, 208],
  [[0, /^(?!\}|\*\/)/, /^[^]/], 208,
   0, 212],
  [2, 271, 210, {"name":"doccomment.type","token":"type"}],
  ["}", 211],
  [e[26], 211,
   3, "def", e[29], 208,
   0, 208],
  ...
  [e[26], 214,
   "{", 215,
   0, 218],
  [2, 271, 216, {"name":"doccomment.type","token":"type"}],
  ["}", 217],
  [e[26], 217,
   3, "def", e[29], 218,
   0, 218],
  [0, 219,
   2, 205, 218, {"name":"doccomment.braced"},
   0, -1],
  [e[30], 220],
  [0, 219,
   0, 218],
