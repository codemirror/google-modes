...
var nodes = [
  ...
  [/^\/\*\*(?!\/)/, 99,
   ...
   /^\/\/.*/, -1],
  [0, 100,
   2, 193, 99, {"name":"doccomment.braced"},
   0, 101],
  [e[29], 102],
  [2, 201, 101, {"name":"doccomment.tagGroup"},
   "*/", -1],
  [0, 100,
   0, 99],
  [[0, /^(?!\*\/)/, /^[^]/], 103,
  ...
  [0, 109,
   0, 110,
   3, "keyword", e[14], 120,
   3, "type", [0, /^[a-zA-Z\¡-\￿_]/, /^[a-zA-Z\¡-\￿_0-9]*/, [5, 209]], 120],
  [3, "keyword", e[15], 111,
   3, "keyword", e[16], 111],
  [3, "type", e[17], 112],
  [1, 9, 113],
  ...
  [3, "operator", e[19], 125,
   3, "keyword", e[20], 125,
   2, 218, 126, {"name":"ParenExpr"},
   3, "atom", e[21], 128,
   3, "number", e[22], 128,
   2, 94, 128, {"name":"string","token":"string"},
   2, 223, 128, {"name":"BlockOf"},
  ...
  [1, 9, 138],
  [1, 124, 139],
  [2, 243, 130, {"name":"fieldName","token":"property"}],
  [1, 124, 130],
  [1, 124, 140],
  [1, 9, 141],
  [1, 9, 142],
  ...
  [1, 244, 171,
   0, 188],
  [1, 9, 172],
  [2, 243, 173, {"name":"fieldName","token":"property"},
   0, 173],
  [1, 9, 174],
  [":", 175,
   0, 176],
  ...
  [1, 244, 181],
  [1, 9, 182],
  [2, 243, 183, {"name":"fieldName","token":"property"},
   0, 183],
  [1, 9, 184],
  [":", 185,
   0, 186],
  ...
  [3, "tag", e[26], 195,
   3, "tag", e[27], 196,
   2, 256, 200, {"name":"doccomment.type","token":"type"}],
  [e[25], 195,
   "{", 197,
   0, 196],
  [[0, /^(?!\}|\*\/)/, /^[^]/], 196,
   0, 200],
  [2, 256, 198, {"name":"doccomment.type","token":"type"}],
  ["}", 199],
  [e[25], 199,
   3, "def", e[28], 196,
   0, 196],
  ...
  [e[25], 202,
   "{", 203,
   0, 206],
  [2, 256, 204, {"name":"doccomment.type","token":"type"}],
  ["}", 205],
  [e[25], 205,
   3, "def", e[28], 206,
   0, 206],
