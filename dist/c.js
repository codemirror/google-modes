(function (global, factory) {
  ...
  var nodes = [
    ...
    ["}", -1],
    [3, "operator", e[20], 184,
     2, 277, 185, {"name":"ParenExpr"},
     3, "atom", e[21], 198,
     3, "number", e[22], 198,
     2, 103, 198, {"name":"string","token":"string"},
     2, 282, 198, {"name":"BlockOf"},
     3, "keyword", e[23], 186,
     3, "meta", e[12], 187,
    ...
    ["]", -1],
    [1, 9, 211],
    [2, 315, -1, {"name":"fieldName","token":"property"}],
    [1, 9, 213],
    [1, 183, -1,
     0, -1],
    [1, 9, 215],
    ...
    [1, 292, 267],
    [1, 9, 268],
    [2, 315, 269, {"name":"fieldName","token":"property"},
     0, 269],
    [1, 9, 270],
    [":", 271,
     "[", 272,
    ...
    [2, 201, -1, {"name":"ParenTokens"},
     2, 325, -1, {"name":"BracketTokens"},
     2, 329, -1, {"name":"BraceTokens"},
