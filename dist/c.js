...
var nodes = [
  ...
  [3, "tag", e[26], 203,
   3, "tag", e[27], 204,
   2, 265, 208, {"name":"doccomment.type","token":"type"}],
  [e[25], 203,
   "{", 205,
   0, 204],
  [[0, /^(?!\}|\*\/)/, /^[^]/], 204,
   0, 208],
  [2, 265, 206, {"name":"doccomment.type","token":"type"}],
  ["}", 207],
  [e[25], 207,
   3, "def", e[28], 204,
   0, 204],
  ...
  [e[25], 210,
   "{", 211,
   0, 214],
  [2, 265, 212, {"name":"doccomment.type","token":"type"}],
  ["}", 213],
  [e[25], 213,
   3, "def", e[28], 214,
   0, 214],
