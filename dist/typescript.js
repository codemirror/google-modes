(function (global, factory) {
  ...
  var nodes = [
    ...
    [1, 6, 429],
    [1, 6, 430],
    [[0, [5, 562], /^[a-zA-Z¡-￿__\$]/, /^[a-zA-Z¡-￿_0-9_\$]*/], 431,
     1, 165, 432],
    [/^\??/, 433],
    [1, 6, 434],
    [1, 6, 435],
    ...
    [1, 6, 465],
    [3, "def", e[19], -1,
     2, 565, -1, {"name":"ArrayPattern"},
     2, 570, -1, {"name":"ObjectPattern"}],
    ["(", 467],
    [1, 6, 468],
    [1, 575, 469],
    [1, 6, 470],
    ...
    ["(", 472],
    [1, 6, 473],
    [2, 615, 474, {"name":"StatementMaybeOf"}],
    [1, 6, 475],
    [1, 165, 476,
     0, 476,
     0, 480],
    ...
    [e[24], 495,
     ...
     0, 497,
     0, -1],
    [2, 641, 498, {"name":"doccomment.type"}],
    [3, "def", /^[a-zA-Z¡-￿_0-9]+/, -1,
     0, -1],
    ["}", 499],
    [[1, "\n", "\t", " ", /^\*(?!\/)/], 499,
     0, 497],
    [3, "def", [0, /^[a-zA-Z¡-￿__\$]/, /^[a-zA-Z¡-￿_0-9_\$]*/, [5, 645]], 506,
     [5, 651], 501],
    ...
    [3, "keyword", e[47], 621,
     0, 621],
    [1, 6, 622],
    [3, "def property", e[19], 627,
     "[", 623,
     3, "number", e[29], 627,
     2, 141, 627, {"name":"string","token":"string"}],
    [1, 6, 624],
    [1, 165, 625],
    [1, 6, 626],
    ["]", 627],
    ...
    [3, "type", "{", 642,
     ...
     "\n", 643,
     0, -1],
    [2, 641, 644, {"name":"doccomment.type"}],
    [/^[\t ]*(?:\*(?!\/)[\t ]*)?/, 641],
    [/^(?=\*\/)/, 641,
     3, "type", "}", 641],
    [1, 6, 646],
    ...
    [1, 367, 670,
     0, 670],
    [1, 6, 667],
    [2, 689, 672, {"name":"ObjectMember"},
     0, -1],
    [1, 6, 673],
    [",", 674,
     0, -1],
    [1, 6, 675],
    [2, 689, 676, {"name":"ObjectMember"},
     0, 676],
    [1, 6, 673],
    [1, 704, 678,
     0, 678,
    ...
    [1, 6, 708],
    [1, 367, -1],
    [3, "def", /^[a-zA-Z¡-￿__\$][a-zA-Z¡-￿_0-9_\$]*(?![a-z]|[A-Z]|[¡-￿]|_|[0-9]|_|\$| *\:)/, 710,
     3, "property", e[19], 714,
     3, "number", e[29], 714,
     2, 141, 714, {"name":"string","token":"string"},
     3, "operator", "...", 718],
    [1, 6, 711],
    [3, "operator", "=", 712,
     0, -1],
