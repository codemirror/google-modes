(function (global, factory) {
  ...
  var nodes = [
    ...
    [1, 387, 641,
     0, 641],
    [1, 6, 638],
    [2, 660, 643, {"name":"ObjectMember"},
     0, -1],
    [1, 6, 644],
    [",", 645,
     0, -1],
    [1, 6, 646],
    [2, 660, 647, {"name":"ObjectMember"},
     0, 647],
    [1, 6, 644],
    [1, 675, 649,
     0, -1],
    ...
    [3, "keyword", e[47], 661,
     0, 661],
    [1, 6, 662],
    [3, "def property", e[19], 663,
     "[", 664,
     3, "number", e[31], 663,
     2, 155, 663, {"name":"string","token":"string"},
     3, "operator", "...", 665],
    [1, 6, 666],
    [1, 6, 667],
    [1, 6, 668],
    ...
    [1, 6, 679],
    [1, 387, -1],
    [3, "def", /^[a-zA-Z¡-￿__\$][a-zA-Z¡-￿_0-9_\$]*(?![a-z]|[A-Z]|[¡-￿]|_|[0-9]|_|\$| *\:)/, 681,
     3, "property", e[19], 685,
     3, "operator", "...", 689],
    [1, 6, 682],
    [3, "operator", "=", 683,
