(function (global, factory) {
  ...
  var nodes = [
    ...
    [1, 6, 195],
    [1, 6, 196],
    [2, 398, 209, {"name":"TypeArgs"},
     0, 209],
    [".", 197,
     "[", 198,
     0, 209],
    [")", 209],
    [2, 403, 199, {"name":"ParamListSpec"}],
    [".", 200],
    [1, 6, 201],
    [1, 6, 202],
    [1, 6, 203],
    ...
    [3, "keyword", e[28], 411,
     ...
     0, 419],
    [1, 6, 412],
    [2, 171, 413, {"name":"TypeParams"},
     0, 413],
    [1, 6, 414],
    [2, 460, 415, {"name":"ParamList"}],
    [1, 6, 416],
    [":", 417,
     0, -1],
    [1, 6, 418],
    ...
    [3, "keyword", e[42], 420,
     "[", 421,
     3, "def property", e[19], 422,
     2, 141, 422, {"name":"string","token":"string"},
     3, "number", e[29], 422],
    [1, 6, 419],
    [1, 6, 423],
    [1, 6, 424],
    [[0, [5, 556], /^[a-zA-Z¡-￿__\$]/, /^[a-zA-Z¡-￿_0-9_\$]*/], 425,
     1, 165, 426],
    [/^\??/, 427],
    [1, 6, 428],
    [1, 6, 429],
    [1, 6, 430],
    [":", 431,
     3, "keyword", /^in(?![a-zA-Z¡-￿_0-9_\$])/, 431],
    ["]", 432],
    [2, 171, 433, {"name":"TypeParams"},
     0, 433,
     0, 434],
    [1, 6, 435],
    [1, 6, 436],
    ...
    [1, 6, 459],
    [3, "def", e[19], -1,
     2, 559, -1, {"name":"ArrayPattern"},
     2, 564, -1, {"name":"ObjectPattern"}],
    ["(", 461],
    [1, 6, 462],
    [1, 569, 463],
    [1, 6, 464],
