(function (global, factory) {
  ...
  var nodes = [
    ...
    [e[24], 495,
     ...
     0, 497,
     0, -1],
    [2, 655, 498, {"name":"doccomment.type"}],
    [3, "def", /^[a-zA-Z¡-￿_0-9]+/, -1,
     0, -1],
    ["}", 499],
    [[1, "\n", "\t", " ", /^\*(?!\/)/], 499,
     0, 497],
    [3, "def", [0, /^[a-zA-Z¡-￿__\$]/, /^[a-zA-Z¡-￿_0-9_\$]*/, [5, 659]], 506,
     [5, 665], 501],
    ...
    [3, "def property", e[19], 641,
     "[", 637,
     3, "number", e[29], 641,
     2, 141, 641, {"name":"string","token":"string"}],
    [1, 6, 638],
    [1, 165, 639],
    [1, 6, 640],
    ["]", 641],
    ...
    [3, "type", "{", 656,
     ...
     "\n", 657,
     0, -1],
    [2, 655, 658, {"name":"doccomment.type"}],
    [/^[\t ]*(?:\*(?!\/)[\t ]*)?/, 655],
    [/^(?=\*\/)/, 655,
     3, "type", "}", 655],
    [1, 6, 660],
    ...
    [1, 367, 684,
     0, 684],
    [1, 6, 681],
    [2, 703, 686, {"name":"ObjectMember"},
     0, -1],
    [1, 6, 687],
    [",", 688,
     0, -1],
    [1, 6, 689],
    [2, 703, 690, {"name":"ObjectMember"},
     0, 690],
    [1, 6, 687],
    [1, 718, 692,
     0, 692,
    ...
    [1, 6, 722],
    [1, 367, -1],
    [3, "def", /^[a-zA-Z¡-￿__\$][a-zA-Z¡-￿_0-9_\$]*(?![a-z]|[A-Z]|[¡-￿]|_|[0-9]|_|\$| *\:)/, 724,
     3, "property", e[19], 728,
     3, "number", e[29], 728,
     2, 141, 728, {"name":"string","token":"string"},
     3, "operator", "...", 732],
    [1, 6, 725],
    [3, "operator", "=", 726,
     0, -1],
