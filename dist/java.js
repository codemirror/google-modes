(function (global, factory) {
  ...
  var nodes = [
    ...
    [1, 5, 194],
    [1, 96, 200],
    [3, "tag", /^\@param(?![a-zA-Z¡-￿_])/, 203,
     3, "tag", /^\@(?:throws|exception)(?![a-zA-Z¡-￿_])/, 204,
     3, "tag", e[35], 211,
     "{", 205],
    [e[33], 203,
     3, "def", e[34], 211,
