...
var nodes = [
  ...
  [3, "tag", e[35], 217,
   3, "tag", e[36], 218,
   2, 346, 222, {"name":"doccomment.type","token":"type"}],
  [e[34], 217,
   "{", 219,
   0, 218],
  [[0, /^(?!\}|\*\/)/, /^[^]/], 218,
   0, 222],
  [2, 346, 220, {"name":"doccomment.type","token":"type"}],
  ["}", 221],
  [e[34], 221,
   3, "def", e[37], 218,
   0, 218],
  ...
  [e[34], 224,
   "{", 225,
   0, 228],
  [2, 346, 226, {"name":"doccomment.type","token":"type"}],
  ["}", 227],
  [e[34], 227,
   3, "def", e[37], 228,
   0, 228],
  ...
  [[5, 352], 252,
   [5, 355], 253],
  [3, "def", e[16], 254,
   2, 358, 254, {"name":"ParamList"}],
  [2, 363, 255, {"name":"SimpleParamList"}],
  [1, 5, 256],
  [1, 5, 257],
  [3, "operator", "->", 258],
  [3, "operator", "->", 258],
  ...
  [3, "def", e[16], 394],
  [1, 5, 395],
  [2, 270, 396, {"name":"ArgList"},
   0, 396],
  [1, 5, 397],
  [2, 332, -1, {"name":"ClassBody"},
   0, -1],
  [2, 115, 399, {"name":"BeforeStatement"}],
  [1, 5, 400],
  [2, 327, 401, {"name":"TypeParams"},
   0, 401],
  [1, 5, 402],
  [3, "def", e[42], 403,
   1, 169, -1],
