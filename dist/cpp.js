...
var nodes = [
  ...
  [[0, /^(?!\}|\*\/)/, /^[^]/], 350,
   0, 354],
  [2, 506, 352, {"name":"doccomment.type","token":"type"}],
  ["}", 353],
  [e[42], 353,
   3, "def", e[45], 350,
   0, 350],
  ...
  [e[42], 356,
   "{", 357,
   0, 360],
  [2, 506, 358, {"name":"doccomment.type","token":"type"}],
  ["}", 359],
  [e[42], 359,
   3, "def", e[45], 360,
   0, 360],
  ...
  [1, 559, 562],
  [/^\}?/, 559],
  [2, 487, 564, {"name":"fieldName","token":"property"}],
  [1, 9, 565],
  ["(", 566,
   "{", 567],
  [1, 9, 568],
