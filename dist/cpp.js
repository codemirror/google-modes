...
var nodes = [
  ...
  [3, "keyword", e[38], 211,
   ...
   "[", 226,
   3, "keyword", e[42], 227,
   2, 424, 228, {"name":"ParenExpr"},
   3, "atom", e[43], 246,
   3, "number", e[19], 246,
   2, 166, 246, {"name":"string","token":"string"},
   2, 429, 246, {"name":"BlockOf"},
   1, 161, 246],
  [1, 9, 214],
  [1, 9, 215],
  [1, 9, 210],
  ...
  [1, 258, 298],
  [1, 9, 299],
  [2, 468, 300, {"name":"InitializerList"},
   0, 300],
  [1, 9, 301],
  [";", -1,
   2, 188, -1, {"name":"Block"}],
  ...
  ["]", -1],
  [1, 9, 320],
  [2, 476, -1, {"name":"fieldName","token":"property"}],
  [1, 9, 322],
  [1, 210, -1],
  [1, 9, 324],
  [1, 210, 325],
  ...
  [1, 258, 365,
   0, 382],
  [1, 9, 366],
  [2, 476, 367, {"name":"fieldName","token":"property"},
   0, 367],
  [1, 9, 368],
  [":", 369,
   0, 370],
  ...
  [1, 258, 375],
  [1, 9, 376],
  [2, 476, 377, {"name":"fieldName","token":"property"},
   0, 377],
  [1, 9, 378],
  [":", 379,
   0, 380],
  ...
  [3, "tag", e[49], 392,
   3, "tag", e[50], 393,
   2, 494, 397, {"name":"doccomment.type","token":"type"}],
  [e[48], 392,
   "{", 394,
   0, 393],
  [[0, /^(?!\}|\*\/)/, /^[^]/], 393,
   0, 397],
  [2, 494, 395, {"name":"doccomment.type","token":"type"}],
  ["}", 396],
  [e[48], 396,
   3, "def", e[51], 393,
   0, 393],
  ...
  [e[48], 399,
   "{", 400,
   0, 403],
  [2, 494, 401, {"name":"doccomment.type","token":"type"}],
  ["}", 402],
  [e[48], 402,
   3, "def", e[51], 403,
   0, 403],
  ...
  [1, 532, 535],
  [/^\}?/, 532],
  [2, 476, 537, {"name":"fieldName","token":"property"}],
  [1, 9, 538],
  ["(", 539,
   "{", 540],
  [1, 9, 541],
