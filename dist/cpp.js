...
var nodes = [
  ...
  ["]", -1],
  [1, 9, 301],
  [2, 499, -1, {"name":"fieldName","token":"property"}],
  [1, 9, 303],
  [1, 200, -1],
  [1, 9, 305],
  [1, 200, 306],
  ...
  [3, "tag", e[45], 355,
   3, "tag", e[46], 356,
   2, 520, 360, {"name":"doccomment.type","token":"type"}],
  [e[44], 355,
   "{", 357,
   0, 356],
  [[0, /^(?!\}|\*\/)/, /^[^]/], 356,
   0, 360],
  [2, 520, 358, {"name":"doccomment.type","token":"type"}],
  ["}", 359],
  [e[44], 359,
   3, "def", e[47], 356,
   0, 356],
  ...
  [e[44], 362,
   "{", 363,
   0, 366],
  [2, 520, 364, {"name":"doccomment.type","token":"type"}],
  ["}", 365],
  [e[44], 365,
   3, "def", e[47], 366,
   0, 366],
  ...
  [3, "keyword", e[31], 484,
   ...
   1, 216, 485],
  [1, 9, 472],
  [2, 288, 479, {"name":"TemplateArgs"}],
  [3, "keyword", e[24], 486,
   3, "keyword", e[19], 486],
  [1, 9, 480],
  [1, 9, 487],
  [1, 9, 488],
  [2, 437, 481, {"name":"ParamList"},
   1, 460, 481,
   0, 481],
  [1, 216, 481],
  ["{", 490],
  ...
  [1, 216, 504],
  [1, 9, 505],
  [2, 499, 506, {"name":"fieldName","token":"property"},
   0, 506],
  [1, 9, 507],
  [":", 508,
   "[", 509,
  ...
  [3, "keyword", e[28], 522,
   ...
   3, "meta", e[17], 524,
   1, 155, -1,
   2, 603, -1, {"name":"ObjectMember"}],
  [1, 9, 523],
  [":", -1],
  [1, 9, 525],
  [2, 347, 526, {"name":"ArgList"},
   0, 526],
  [1, 9, 527],
  [/^\;?/, -1],
  [1, 617, 529,
  ...
  [3, "keyword", e[31], 604,
   3, "keyword", e[32], 604,
   3, "keyword", e[33], 604,
   3, "def", [0, [7, "localConstructorAhead"], /^\~?/, /^[a-zA-Z¡-￿_]/, /^[a-zA-Z¡-￿_0-9]*/], 607,
   1, 216, 605],
  [1, 9, 603],
  [1, 9, 606],
  [1, 639, 607],
  ...
  [1, 138, -1,
   3, "number", e[26], -1],
  [2, 499, 629, {"name":"fieldName","token":"property"}],
  [1, 9, 630],
  ["(", 631,
   "{", 632],
  [1, 9, 633],
