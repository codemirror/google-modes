...
var nodes = [
  ...
  [0, 82,
   1, 290, 85,
   2, 297, 86, {"name":"qualifiedVariableName","token":"qualified"}],
  [1, 9, 87],
  [1, 9, 88],
  [1, 298, -1],
  [1, 308, 89,
  ...
  [/^\/\*\*(?!\/)/, 169,
   ...
   /^\/\/.*/, -1],
  [0, 170,
   2, 374, 169, {"name":"doccomment.braced"},
   0, 171],
  [e[52], 172],
  [2, 382, 171, {"name":"doccomment.tagGroup"},
   "*/", -1],
  [0, 170,
   0, 169],
  [[0, /^(?!\*\/)/, /^[^]/], 173,
