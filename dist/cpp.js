(function (global, factory) {
  ...
  var nodes = [
    ...
    ["]", -1],
    [2, 322, -1, {"name":"ParenTokens"},
     2, 725, -1, {"name":"BracketTokens"},
     2, 729, -1, {"name":"BraceTokens"},
    ...
    [e[59], 736,
     ">", -1],
    [1, 733, 737,
     2, 134, 737, {"name":"string","token":"string"},
     /^[^]/, 737],
    [1, 9, 735],
    [1, 438, 739],
    [1, 9, 740],
    ...
    [3, "keyword", e[29], 755,
     3, "keyword", e[30], 755,
     3, "keyword", e[31], 755,
     3, "def", [0, [7, "localConstructorAhead"], /^\~?/, /^[a-zA-Z¡-￿_]/, /^[a-zA-Z¡-￿_0-9]*/], 758,
     1, 438, 756],
    [1, 9, 754],
    [1, 9, 757],
    [1, 795, 758],
    ...
    [1, 127, -1,
     3, "number", e[22], -1],
    [1, 367, 784,
     2, 583, 785, {"name":"fieldName","token":"property"}],
    [1, 9, 783],
    [1, 9, 786],
    ["(", 787,
     "{", 788],
