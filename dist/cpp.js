(function (global, factory) {
  ...
  var nodes = [
    ...
    ["]", -1],
    [2, 296, -1, {"name":"ParenTokens"},
     2, 751, -1, {"name":"BracketTokens"},
     2, 755, -1, {"name":"BraceTokens"},
    ...
    [e[59], 762,
     ">", -1],
    [1, 759, 763,
     2, 114, 763, {"name":"string","token":"string"},
     /^[^]/, 763],
    [1, 9, 761],
    [1, 414, 765],
    [1, 9, 766],
    ...
    [3, "keyword", e[29], 781,
     3, "keyword", e[30], 781,
     3, "keyword", e[31], 781,
     3, "def", [0, [7, "localConstructorAhead"], /^\~?/, /^[a-zA-Z¡-￿_]/, /^[a-zA-Z¡-￿_0-9]*/], 789,
     1, 414, 782],
    [1, 9, 780],
    [1, 9, 783],
    [1, 828, 784],
    ...
    [1, 107, -1,
     3, "number", e[20], -1],
    [1, 339, 815,
     2, 591, 816, {"name":"fieldName","token":"property"}],
    [1, 9, 814],
    [1, 9, 817],
    [2, 347, 818, {"name":"TemplateArgs"},
     0, 818],
    [1, 9, 819],
    ["(", 820,
     "{", 821],
