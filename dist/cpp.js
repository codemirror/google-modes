(function (global, factory) {
  ...
  var nodes = [
    ...
    [e[58], -1],
    [2, 494, -1, {"name":"ParenTokens"},
     2, 842, -1, {"name":"BracketTokens"},
     2, 846, -1, {"name":"BraceTokens"},
     ...
     /^(?![\)\]\}])./, -1],
    ["::", 741,
     /^(?=[a-zA-Z¡-￿_][a-zA-Z¡-￿_0-9]*\:\:)/, 742],
    [0, 740,
     2, 388, -1, {"name":"qualifiedVariableName","token":"qualified"}],
    [3, "variable qualifier", e[21], 743],
    ["::", 741],
    ["[", 745],
    [1, 9, 746],
    [/^(?!\[)/, 747],
    ...
    [e[59], 792,
     ">", -1],
    [1, 789, 793,
     2, 124, 793, {"name":"string","token":"string"},
     /^[^]/, 793],
    [1, 9, 791],
    [1, 456, 795],
    [1, 9, 796],
    ...
    [3, "keyword", e[29], 811,
     3, "keyword", e[30], 811,
     3, "keyword", e[31], 811,
     3, "def", [0, [7, "localConstructorAhead"], /^\~?/, /^[a-zA-Z¡-￿_]/, /^[a-zA-Z¡-￿_0-9]*/], 819,
     1, 456, 812],
    [1, 9, 810],
    [1, 9, 813],
    [1, 874, 814],
    ...
    [1, 117, 858,
     0, 858],
    [1, 381, 861,
     2, 623, 862, {"name":"fieldName","token":"property"}],
    [1, 9, 860],
    [1, 9, 863],
    [2, 389, 864, {"name":"TemplateArgs"},
     0, 864],
    [1, 9, 865],
    ["(", 866,
     "{", 867],
