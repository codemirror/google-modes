(function (global, factory) {
  ...
  var nodes = [
    ...
    ["(", 274],
    [1, 6, 275],
    [2, 346, 276, {"name":"StatementMaybeOf"}],
    [1, 6, 277],
    [1, 149, 278,
     0, 278,
     0, 282],
    ...
    [/^(?=\*\/)/, 305,
     3, "type", "}", 305],
    [3, "def", [0, /^[a-zA-Z¡-￿__\$]/, /^[a-zA-Z¡-￿_0-9_\$]*/, [5, 351]], 311,
     [5, 353], 310],
    [2, 268, 311, {"name":"ParamList"}],
    [1, 6, 312],
    [2, 356, -1, {"name":"ArrowRest"}],
    ["[", 314],
    [1, 6, 315],
    [1, 359, 316],
    [1, 6, 317],
    ...
    [1, 376, 345,
     0, 345],
    [1, 6, 342],
    [2, 7, 347, {"name":"Statement"}],
    [1, 6, 348],
    [3, "keyword", /^of(?![a-zA-Z¡-￿_0-9_\$])/, 349,
     0, -1],
    [1, 6, 350],
    [1, 149, -1],
    [1, 6, 352],
    ["=>", -1],
    [2, 268, 354, {"name":"ParamList"}],
    [1, 6, 355],
    ["=>", -1],
    [3, "operator", "=>", 357],
    [1, 6, 358],
    ...
    [1, 158, 364,
     0, 364],
    [1, 6, 361],
    [2, 284, 366, {"name":"ObjectMember"},
     0, -1],
    [1, 6, 367],
    [",", 368,
     0, -1],
    [1, 6, 369],
    [2, 284, 370, {"name":"ObjectMember"},
     0, 370],
    [1, 6, 367],
    [1, 155, 372],
    [1, 6, 373],
    ...
    [1, 6, 375],
    [1, 158, -1],
    [3, "def", /^[a-zA-Z¡-￿__\$][a-zA-Z¡-￿_0-9_\$]*(?![a-z]|[A-Z]|[¡-￿]|_|[0-9]|_|\$| *\:)/, 377,
     3, "property", e[20], 381,
     3, "operator", "...", 385],
    [1, 6, 378],
    [3, "operator", "=", 379,
