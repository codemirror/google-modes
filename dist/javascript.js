(function (global, factory) {
  ...
  var nodes = [
    ...
    [3, "keyword", /^(?:get|set|async)(?![a-zA-Z¡-￿_0-9_\$])(?! *[\,\}\:\(])/, 275,
     0, 275],
    [1, 6, 276],
    [3, "def property", e[20], 277,
     "[", 278,
     3, "number", e[31], 277,
     2, 116, 277, {"name":"string","token":"string"},
     3, "operator", "...", 279],
    [1, 6, 280],
    [1, 6, 281],
    [1, 6, 282],
