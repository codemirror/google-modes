(function (global, factory) {
  ...
  var nodes = [
    ...
    [1, 146, -1],
    ["]", 284],
    [3, "tag", /^\@(?:member|param|arg(?:ument)?|module|namespace|typedef)(?![a-zA-Z¡-￿_])/, 297,
     3, "tag", /^\@[a-zA-Z¡-￿_]+/, -1],
    [e[38], 297,
     "{", 298,
     0, 299,
