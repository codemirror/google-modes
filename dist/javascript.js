(function (global, factory) {
  ...
  var nodes = [
    ...
    ["{", 189],
    [1, 293, 190,
     2, 299, 191, {"name":"doccomment.type"}],
    [[0, /^(?!\}|\*\/)/, /^[^]/], 190,
     0, 191],
    ["}", -1],
    [1, 293, 193],
    ...
    [3, "atom", e[26], -1,
     ...
     3, "string-2", e[32], -1,
     1, 133, -1,
     2, 307, -1, {"name":"ArrayLiteral"},
     2, 312, -1, {"name":"ObjectLiteral"},
    ...
    [e[37], 294,
     ...
     0, 296,
     0, -1],
    [2, 299, 297, {"name":"doccomment.type"}],
    [3, "def", /^[a-zA-Z¡-￿_]+/, -1,
     0, -1],
    ["}", 298],
    [[1, "\n", "\t", " ", "*"], 298,
    ...
    [3, "type", "{", 300,
     ...
     "\n", 301,
     0, -1],
    [2, 299, 302, {"name":"doccomment.type"}],
    [/^[\t ]*(?:\*[\t ]*)?/, 299],
    [/^(?=\*\/)/, 299,
     3, "type", "}", 299],
    [3, "def", [0, /^[a-zA-Z¡-￿__\$]/, /^[a-zA-Z¡-￿_0-9_\$]*/, [5, 340]], 305,
     [5, 342], 304],
    [2, 260, 305, {"name":"ParamList"}],
    [1, 6, 306],
    [2, 345, -1, {"name":"ArrowRest"}],
    ["[", 308],
    [1, 6, 309],
    [1, 348, 310],
    [1, 6, 311],
    ...
    [1, 150, 353,
     0, 353],
    [1, 6, 350],
    [2, 278, 355, {"name":"ObjectMember"},
     0, -1],
    [1, 6, 356],
    [",", 357,
     0, -1],
    [1, 6, 358],
    [2, 278, 359, {"name":"ObjectMember"},
     0, 359],
    [1, 6, 356],
    [1, 147, 361],
    [1, 6, 362],
    ...
    [1, 6, 364],
    [1, 150, -1],
    [3, "def", /^[a-zA-Z¡-￿__\$][a-zA-Z¡-￿_0-9_\$]*(?![a-z]|[A-Z]|[¡-￿]|_|[0-9]|_|\$| *\:)/, 366,
     3, "property", e[17], 370,
     3, "operator", "...", 374],
    [1, 6, 367],
    [3, "operator", "=", 368,
