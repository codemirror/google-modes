(function (global, factory) {
  ...
  var nodes = [
    ...
    ["{", 189],
    [1, 291, 190,
     2, 297, 191, {"name":"doccomment.type"}],
    [[0, /^(?!\}|\*\/)/, /^[^]/], 190,
     0, 191],
    ["}", -1],
    [1, 291, 193],
    ...
    [3, "atom", e[26], -1,
     ...
     3, "string-2", e[32], -1,
     1, 133, -1,
     2, 305, -1, {"name":"ArrayLiteral"},
     2, 310, -1, {"name":"ObjectLiteral"},
     2, 315, -1, {"name":"ParenExpr"}],
    [1, 6, 200],
    [1, 198, -1],
    [1, 6, 202],
    [".", 203,
    ...
    ["(", 266],
    [1, 6, 267],
    [2, 338, 268, {"name":"StatementMaybeOf"}],
    [1, 6, 269],
    [1, 141, 270,
     0, 270,
     0, 274],
    ...
    [1, 6, 275],
    [")", -1],
    [3, "keyword", /^(?:get|set|async)(?![a-zA-Z¡-￿_0-9_\$])(?! *[\,\}\:\(])/, 277,
     0, 277],
    [1, 6, 278],
    [3, "def property", e[17], 279,
     "[", 280,
     3, "number", e[31], 279,
     2, 122, 279, {"name":"string","token":"string"},
     3, "operator", "...", 281],
    [1, 6, 282],
    [1, 6, 283],
    [1, 6, 284],
    ...
    [1, 150, -1],
    ["]", 279],
    [3, "tag", /^\@(?:member|param|arg(?:ument)?|module|namespace|typedef)(?![a-zA-Z¡-￿_])/, 292,
     3, "tag", /^\@[a-zA-Z¡-￿_]+/, -1],
    [e[37], 292,
     "{", 293,
     0, 294,
     0, -1],
    [2, 297, 295, {"name":"doccomment.type"}],
    [3, "def", /^[a-zA-Z¡-￿_]+/, -1,
     0, -1],
    ["}", 296],
    [[1, "\n", "\t", " ", "*"], 296,
    ...
    [3, "type", "{", 298,
     ...
     "\n", 299,
     0, -1],
    [2, 297, 300, {"name":"doccomment.type"}],
    [/^[\t ]*(?:\*[\t ]*)?/, 297],
    [/^(?=\*\/)/, 297,
     3, "type", "}", 297],
    [3, "def", [0, /^[a-zA-Z¡-￿__\$]/, /^[a-zA-Z¡-￿_0-9_\$]*/, [5, 343]], 303,
     [5, 345], 302],
    [2, 260, 303, {"name":"ParamList"}],
    [1, 6, 304],
    [2, 348, -1, {"name":"ArrowRest"}],
    ["[", 306],
    [1, 6, 307],
    [1, 351, 308],
    [1, 6, 309],
    ...
    [1, 368, 337,
     0, 337],
    [1, 6, 334],
    [2, 7, 339, {"name":"Statement"}],
    [1, 6, 340],
    [3, "keyword", /^of(?![a-zA-Z¡-￿_0-9_\$])/, 341,
     0, -1],
    [1, 6, 342],
    [1, 141, -1],
    [1, 6, 344],
    ["=>", -1],
    [2, 260, 346, {"name":"ParamList"}],
    [1, 6, 347],
    ["=>", -1],
    [3, "operator", "=>", 349],
    [1, 6, 350],
    ...
    [1, 150, 356,
     0, 356],
    [1, 6, 353],
    [2, 276, 358, {"name":"ObjectMember"},
     0, -1],
    [1, 6, 359],
    [",", 360,
     0, -1],
    [1, 6, 361],
    [2, 276, 362, {"name":"ObjectMember"},
     0, 362],
    [1, 6, 359],
    [1, 147, 364],
    [1, 6, 365],
    ...
    [1, 6, 367],
    [1, 150, -1],
    [3, "def", /^[a-zA-Z¡-￿__\$][a-zA-Z¡-￿_0-9_\$]*(?![a-z]|[A-Z]|[¡-￿]|_|[0-9]|_|\$| *\:)/, 369,
     3, "property", e[17], 373,
     3, "operator", "...", 377],
    [1, 6, 370],
    [3, "operator", "=", 371,
