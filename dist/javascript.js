...
var nodes = [
  ...
  [1, 6, 287],
  [")", -1],
  [3, "keyword", /^(?:get|set|async)(?![a-zA-Z\¡-\￿_0-9_\$])(?! *[\,\}\:])/, 289,
   0, 289],
  [1, 6, 290],
  [3, "property", e[18], 291,
   "[", 292,
  ...
  [1, 159, 375,
   0, 375],
  [1, 6, 372],
  [2, 288, 377, {"name":"ObjectMember"},
   0, -1],
  [1, 6, 378],
  [",", 379,
   0, -1],
  [1, 6, 380],
  [2, 288, 381, {"name":"ObjectMember"},
   0, 381],
  [1, 6, 378]
];
var start = 0;
