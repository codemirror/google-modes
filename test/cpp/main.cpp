...
[type int] [def main]() {
  ...
  [variable cout] [operator <<] [string "vector size = "] [operator <<] [variable-2 vec].[property size]() [operator <<] [variable endl];
  ...
  [keyword for] ([variable-2 i] [operator =] [number 0]; [variable-2 i] [operator <] [number 5]; [variable-2 i][operator ++]) {
    [variable-2 vec].[property push_back]([variable-2 i]);
  }

  [comment // display extended size of vec]
  [variable cout] [operator <<] [string "extended vector size = "] [operator <<] [variable-2 vec].[property size]() [operator <<] [variable endl];
  ...
  [type vector]<[type int]>::[type iterator] [def v] [operator =] [variable-2 vec].[property begin]();
  [keyword while] ([variable-2 v] [operator !=] [variable-2 vec].[property end]()) {
